...
public class LaplaceSmoothing {
	...
	public static void matchingScore(int qno, HashMap<String,Integer> len, HashMap<String,ArrayList<Tf_index>> tf, long vocab, ArrayList<String> docnos) throws IOException
	{
